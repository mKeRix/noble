...
Noble.prototype.resetBindings = function () {
  this._bindings.resetBindings();
};

Noble.prototype.stopSocket = function () {
  this._bindings.stopSocket();
};
...
Noble.prototype.onConnect = function (peripheralUuid, error) {
  ...
  } else if (peripheralUuid) {
    this.emit('warning', `unknown peripheral ${peripheralUuid} connected!`);
  }
};

Noble.prototype.cancelConnect = function (peripheralUuid) {
  this._bindings.cancelConnect(peripheralUuid);
}
