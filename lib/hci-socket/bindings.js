...
NobleBindings.prototype.cancelConnect = function (peripheralUuid) {
  if (this._pendingConnectionUuid === peripheralUuid) {
    ...
    this._connectionQueue = this._connectionQueue.filter(x => x !== peripheralUuid)
  }
}
...
NobleBindings.prototype.resetBindings = function () {
  this._hci.resetBindings();
  this._gap.resetBindings();
};

NobleBindings.prototype.stopSocket = function () {
  this._hci.stopSocket();
};
